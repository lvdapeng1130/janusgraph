...
```
```bash
mvn versions:set -DnewVersion=KGYY_R3.01_20210326-hbase1
...
mvn clean package -Pjanusgraph-release -Dgpg.skip=true -DskipTests=true -Dtest.skip.tp=true -Drat.skip=true -Denforcer.skip=true -Pelasticsearch6 -Dhbase.profile -Phbase1 -Delasticsearch.version=6.6.0 -Dcheckstyle.skip -Dmaven.javadoc.skip=true
clean deploy source:jar -Pjanusgraph-release -Dgpg.skip=true -DskipTests=true -Dtest.skip.tp=true -Drat.skip=true -Denforcer.skip=true -Dhbase.profile -Phbase1 ${elasticsearch_option} -Delasticsearch.version=${elasticsearchVersion} -Dhbase1.version=${hbaseVersion}
```
```bash
...
mvn clean package -Pjanusgraph-release -Dgpg.skip=true -DskipTests=true -Dtest.skip.tp=true -Drat.skip=true -Denforcer.skip=true -Pelasticsearch6 -Delasticsearch.version=6.6.0 -Dcheckstyle.skip -Dmaven.javadoc.skip=true

mvn clean package -Pjanusgraph-release -Dgpg.skip=true -DskipTests=true -Dtest.skip.tp=true -Drat.skip=true -Denforcer.skip=true -Pelasticsearch7 -Delasticsearch.version=7.6.2 -Dcheckstyle.skip -Dmaven.javadoc.skip=true

mvn clean compile -Pjanusgraph-release -Dgpg.skip=true -DskipTests=true -Dtest.skip.tp=true -Drat.skip=true -Denforcer.skip=true -Pelasticsearch7 -Delasticsearch.version=7.6.2 -Dcheckstyle.skip -Dmaven.javadoc.skip=true
```
```bash
...
mvn clean package -Phuawei -Pjanusgraph-release -Dgpg.skip=true -DskipTests=true -Dtest.skip.tp=true -Drat.skip=true -Denforcer.skip=true -Pelasticsearch6 -Dhbase.profile -Phbase1 -Delasticsearch.version=6.7.1 -Dcheckstyle.skip -Dmaven.javadoc.skip=true
```
```bash
