 ...
 */
public class TrsGraphSONSerializers {

    private TrsGraphSONSerializers() {
    }
    ...
    final static class EdgeJacksonSerializer extends StdScalarSerializer<Edge> {
        ...
        private void writeProperties(final Edge edge, final JsonGenerator jsonGenerator) throws IOException {
            ...
            if (elementProperties.hasNext()) {
                ...
                jsonGenerator.writeStartObject();
                elementProperties.forEachRemaining(prop -> TrsGraphSONUtil.safeWriteObjectField(jsonGenerator, prop.key(), prop));
                jsonGenerator.writeEndObject();
            }
        }
    }
    ...
    final static class VertexPropertyJacksonSerializer extends StdScalarSerializer<VertexProperty> {
        ...
        public VertexPropertyJacksonSerializer(final boolean normalize, final boolean includeLabel,final boolean includePropertyProperty) {
