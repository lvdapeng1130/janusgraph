 ...
 */
public class TrsGraphSONTypeDeserializer extends TypeDeserializerBase {
    ...
    TrsGraphSONTypeDeserializer(final JavaType baseType, final TypeIdResolver idRes, final String typePropertyName,
