...
public class AbstractKGgraphTest {
    ...
    public void startHBase() throws IOException, ConfigurationException, ScriptException {
        ...
        String dataPath=this.getClass().getResource("/trsgraph-hbase-es-244_draw.properties").getFile();
        conf = ConfigurationUtil.loadPropertiesConfig(dataPath);
        graph = JanusGraphFactory.open(conf);
        g = graph.traversal(KydsjTraversalSource.class).withoutStrategies(LazyBarrierStrategy.class);
