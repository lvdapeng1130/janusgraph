 ...
 */
public final class SparkJanusGraphGryoSerializerProvider extends SparkJanusGraphProvider {

    public Map<String, Object> getBaseConfiguration(final String graphName, final Class<?> test, final String testMethodName, final LoadGraphWith.GraphData loadGraphWith) {
        if (!SparkJanusGraphGryoSerializerProvider.class.getCanonicalName().equals(System.getProperty(PREVIOUS_SPARK_PROVIDER, null))) {
            Spark.close();
            KryoShimServiceLoader.close();
            System.setProperty(PREVIOUS_SPARK_PROVIDER, SparkJanusGraphGryoSerializerProvider.class.getCanonicalName());
        }
