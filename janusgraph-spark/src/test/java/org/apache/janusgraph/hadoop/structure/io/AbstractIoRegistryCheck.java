...
package org.apache.janusgraph.hadoop.structure.io;
...
public abstract class AbstractIoRegistryCheck extends AbstractGremlinTest {
    ...
    public void checkGryoV1d0IoRegistryCompliance(final JanusGraph graph, final Class<? extends GraphComputer> graphComputerClass) throws Exception {
    ...
    public void checkGryoV3d0IoRegistryCompliance(final JanusGraph graph, final Class<? extends GraphComputer> graphComputerClass) throws Exception {
        final File input = TestHelper.generateTempFile(this.getClass(), "gryo-io-registry", ".kryo");
        graph.configuration().setProperty(Constants.GREMLIN_HADOOP_GRAPH_READER, GryoInputFormat.class.getCanonicalName());
        graph.configuration().setProperty(Constants.GREMLIN_HADOOP_GRAPH_WRITER, GryoOutputFormat.class.getCanonicalName());
        graph.configuration().setProperty(Constants.GREMLIN_HADOOP_INPUT_LOCATION, Storage.toPath(input));
    ...
    public void checkGraphSONIoRegistryCompliance(final JanusGraph graph, final Class<? extends GraphComputer> graphComputerClass) throws Exception {
    ...
    private void validateIoRegistryGraph(final JanusGraph graph,
